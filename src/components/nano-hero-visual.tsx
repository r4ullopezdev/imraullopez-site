export function NanoHeroVisual() {
  return (
    <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[radial-gradient(circle_at_20%_0%,rgba(34,211,238,0.22),transparent_30%),radial-gradient(circle_at_80%_10%,rgba(96,165,250,0.18),transparent_35%),linear-gradient(180deg,#08111a,#07101a)] p-6 shadow-[0_40px_120px_rgba(0,0,0,0.4)]">
      ...
      <div className="pulse-orbit absolute left-10 top-10 h-24 w-24 rounded-full bg-cyan-300/10 blur-2xl" />
      <div className="pulse-orbit absolute bottom-8 right-10 h-28 w-28 rounded-full bg-blue-400/10 blur-2xl [animation-delay:1.2s]" />
      <div className="relative grid gap-5 lg:grid-cols-[1.2fr_1fr]">
        <div className="float-slow space-y-4 rounded-[28px] border border-white/10 bg-[#0c1522]/80 p-6">
        ...
        <div className="space-y-4">
          <div className="float-slower rounded-[28px] border border-white/10 bg-white/[0.04] p-5">
